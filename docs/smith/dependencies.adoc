...
The installation steps are described in more details in the https://writingsystems.info/topics/fonts/building-and-modifying-sil-fonts/[Building & Modifying SIL Fonts]. 
