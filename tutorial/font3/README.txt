...
(https://scripts.sil.org/andika), including details on what ranges are
supported.
...
See the website (https://scripts.sil.org/andika) for further documentation.
Andika FAQ (https://scripts.sil.org/Andika_FAQ-KI) for frequently
asked questions and their answers.
See the SIL Unicode Roman FAQ (https://scripts.sil.org/ComplexRomanFontFAQ)
...
XKB (http://www.x.org/wiki/XKB) or Ukelele (https://scripts.sil.org/ukelele)
can be helpful.
